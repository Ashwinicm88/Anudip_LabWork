...
public class App
{
	public static void main(String args[]) {
		...
		try {
			...
			person.setpName("Rani");
			person.setEmail("rani@gmail.com");
			
			Person person1=new Person();
			person1.setpName("ushashri");
			person1.setEmail("ushashri@gmail.com");
			
			Person person2=new Person();
			person2.setpName("sushma");
			person2.setEmail("sushma@gmail.com");
