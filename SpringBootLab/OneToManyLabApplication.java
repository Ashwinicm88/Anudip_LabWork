...
public class OneToManyLabApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Customer customer=new Customer("Ashwini");
		Customer customer1=new Customer("Rani");
		Product Nailpaint=new Product("zudio",customer);
		Product bodylotion=new Product("Nivia",customer);
		Product mobile=new Product("Narzo 50 A", customer1);
